...
<head>
    <meta charset="UTF-8">
    <title>MusicTrans File Upload</title>
...
<div class="login">
    <div id="attachment">
        ...
        <label><input class="fileinput" type="file" name="uploadfile" action="audio/*">File Select</label>
        <span class="filename">not selected</span>
    </div>
